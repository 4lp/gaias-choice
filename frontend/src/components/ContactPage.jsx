							...
							<div className="container">
								<div className="row">
									<div className="col-12 text-center">
										<h2 className="text-center page-title">Contact Us</h2>
									...
									<div className="col-12 col-md-6 map">
										<div className="map-container">
											<h6 className="text-center">Email us at gaiaschoice@gmail.com or use the contact form to get in touch</h6>
